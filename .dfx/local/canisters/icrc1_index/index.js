...
import { idlFactory } from './icrc1_index.did.js';
export { idlFactory } from './icrc1_index.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ICRC1_INDEX_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icrc1_index.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icrc1_index canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icrc1_index.did.js")._SERVICE>}
 */
