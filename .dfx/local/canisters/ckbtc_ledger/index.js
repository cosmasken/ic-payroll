...
export const canisterId = process.env.CKBTC_LEDGER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ckbtc_ledger.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ckbtc_ledger canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ckbtc_ledger.did.js")._SERVICE>}
 */
