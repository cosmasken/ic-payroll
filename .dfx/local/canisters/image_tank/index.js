...
import { idlFactory } from './image_tank.did.js';
export { idlFactory } from './image_tank.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.IMAGE_TANK_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./image_tank.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the image_tank canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./image_tank.did.js")._SERVICE>}
 */
export const image_tank = createActor(canisterId);
