...
export interface Autom8Payment {
  'status' : { 'Queued' : null } |
    { 'Paid' : null } |
    { 'Rejected' : null } |
    { 'Unpaid' : null } |
  ...
  'memo' : string,
  'created_at' : bigint,
  'scheduled_after' : bigint,
  'amount' : bigint,
  'receiver' : string,
}
export interface Autom8PaymentArgs {
  'memo' : string,
  'scheduled_after' : bigint,
  'amount' : bigint,
  'receiver' : string,
...
export interface Backend {
  'CanistertoSubAccount' : ActorMethod<[string, bigint], Response>,
  'bulkPayment' : ActorMethod<[Array<Payment>], Response_9>,
  'cancelRecurringTimer' : ActorMethod<[bigint], undefined>,
  'checkPayroll' : ActorMethod<[], undefined>,
  'createAccount' : ActorMethod<[User], Response_7>,
  'create_Autom8Payment' : ActorMethod<[Autom8PaymentArgs], Response_8>,
  'create_department' : ActorMethod<[CreateDepartmentArgs], Response_6>,
  'create_designation' : ActorMethod<[CreateDesignationArgs], Response_5>,
  'create_emp' : ActorMethod<[CreateEmpArgs], Response_4>,
  'create_organization' : ActorMethod<[CreateOrganizationArgs], Response_3>,
  'emailExists' : ActorMethod<[string], boolean>,
  'generateCode' : ActorMethod<[string], string>,
  'generatePayslip' : ActorMethod<
    [string, string, string, string, bigint],
    PayslipData
  >,
  'generateUUID' : ActorMethod<[], string>,
  'getAutom8Payments' : ActorMethod<[], Array<Autom8Payment>>,
  'getAutom8PaymentsLength' : ActorMethod<[], string>,
  'getBulkPayments' : ActorMethod<[], Array<Payment>>,
  ...
  'getEmpByPrincipal' : ActorMethod<[Principal], Response_4>,
  ...
  'getRandomNat' : ActorMethod<[], bigint>,
  ...
  'getUser' : ActorMethod<[], Response_7>,
  'getUserByPrincipal' : ActorMethod<[Principal], Response_7>,
  ...
  'remove_department' : ActorMethod<[RemoveDepartmentArgs], Response_6>,
  'remove_designation' : ActorMethod<[RemoveDesignationArgs], Response_5>,
  'remove_emp' : ActorMethod<[RemoveEmpArgs], Response_4>,
  'remove_organization' : ActorMethod<[RemoveOrganizationArgs], Response_3>,
...
export interface Payment { 'amount' : bigint, 'receiver' : string }
...
export interface RemoveDepartmentArgs { 'department_id' : bigint }
export interface RemoveDesignationArgs { 'designation_id' : bigint }
export interface RemoveEmpArgs { 'employee_id' : bigint }
export interface RemoveOrganizationArgs { 'organization_id' : bigint }
