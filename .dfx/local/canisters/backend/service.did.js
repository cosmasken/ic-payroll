export const idlFactory = ({ IDL }) => {
  ...
  const Backend = IDL.Service({
    ...
    'createAccount' : IDL.Func([User], [Response_3], []),
    'create_department' : IDL.Func([CreateDepartmentArgs], [Response_8], []),
    'create_designation' : IDL.Func([CreateDesignationArgs], [Response_7], []),
    ...
    'generatePayslip' : IDL.Func([IDL.Nat], [Response_4], []),
    ...
    'getUser' : IDL.Func([], [Response_3], []),
    'getUserByPrincipal' : IDL.Func([IDL.Principal], [Response_3], []),
