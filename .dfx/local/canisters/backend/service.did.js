export const idlFactory = ({ IDL }) => {
  ...
  const Payment = IDL.Record({ 'amount' : IDL.Nat, 'receiver' : IDL.Text });
  const Response_9 = IDL.Record({
    'status' : IDL.Nat16,
    'data' : IDL.Opt(IDL.Vec(Payment)),
    'status_text' : IDL.Text,
    'error_text' : IDL.Opt(IDL.Text),
  });
  ...
  const Autom8PaymentArgs = IDL.Record({
    'memo' : IDL.Text,
    'scheduled_after' : IDL.Nat,
    'amount' : IDL.Nat,
    'receiver' : IDL.Text,
  });
  const Autom8Payment = IDL.Record({
    'status' : IDL.Variant({
      'Queued' : IDL.Null,
      'Paid' : IDL.Null,
      'Rejected' : IDL.Null,
  ...
  const Response__1 = IDL.Record({
    'body' : IDL.Vec(IDL.Nat8),
    'headers' : IDL.Vec(HeaderField),
    'streaming_strategy' : IDL.Opt(StreamingStrategy),
    'status_code' : IDL.Nat16,
  });
  const RemoveDepartmentArgs = IDL.Record({ 'department_id' : IDL.Nat });
  const RemoveDesignationArgs = IDL.Record({ 'designation_id' : IDL.Nat });
  const RemoveEmpArgs = IDL.Record({ 'employee_id' : IDL.Nat });
  const RemoveOrganizationArgs = IDL.Record({ 'organization_id' : IDL.Nat });
  ...
  const Backend = IDL.Service({
    'CanistertoSubAccount' : IDL.Func([IDL.Text, IDL.Nat], [Response], []),
    'bulkPayment' : IDL.Func([IDL.Vec(Payment)], [Response_9], []),
    'cancelRecurringTimer' : IDL.Func([IDL.Nat], [], []),
    'checkPayroll' : IDL.Func([], [], []),
    'createAccount' : IDL.Func([User], [Response_7], []),
    'create_Autom8Payment' : IDL.Func([Autom8PaymentArgs], [Response_8], []),
    'create_department' : IDL.Func([CreateDepartmentArgs], [Response_6], []),
    'create_designation' : IDL.Func([CreateDesignationArgs], [Response_5], []),
    'create_emp' : IDL.Func([CreateEmpArgs], [Response_4], []),
    ...
    'generatePayslip' : IDL.Func(
        [IDL.Text, IDL.Text, IDL.Text, IDL.Text, IDL.Nat],
        [PayslipData],
        [],
      ),
    'generateUUID' : IDL.Func([], [IDL.Text], []),
    'getAutom8Payments' : IDL.Func([], [IDL.Vec(Autom8Payment)], ['query']),
    'getAutom8PaymentsLength' : IDL.Func([], [IDL.Text], ['query']),
    'getBulkPayments' : IDL.Func([], [IDL.Vec(Payment)], []),
    ...
    'getEmpByPrincipal' : IDL.Func([IDL.Principal], [Response_4], []),
    ...
    'getUser' : IDL.Func([], [Response_7], []),
    'getUserByPrincipal' : IDL.Func([IDL.Principal], [Response_7], []),
    ...
    'http_request' : IDL.Func([Request], [Response__1], ['query']),
    'isReg' : IDL.Func([], [IDL.Bool], []),
    'isRegistered' : IDL.Func([], [IDL.Bool], []),
    'remove_department' : IDL.Func([RemoveDepartmentArgs], [Response_6], []),
    'remove_designation' : IDL.Func([RemoveDesignationArgs], [Response_5], []),
    'remove_emp' : IDL.Func([RemoveEmpArgs], [Response_4], []),
    'remove_organization' : IDL.Func(
        [RemoveOrganizationArgs],
        [Response_3],
        [],
      ),
