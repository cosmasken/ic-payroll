...
export const canisterId = process.env.IC_SIWE_PROVIDER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ic_siwe_provider.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ic_siwe_provider canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ic_siwe_provider.did.js")._SERVICE>}
 */
