<template>
  ...
  <div class="mx-auto">
    <fieldset>
      <legend class="text-sm font-semibold leading-6 text-gray-900 sm:px-32 ">Select an account type</legend>
      <RadioGroup v-model="selectedMailingLists" class="mt-6 mx-auto grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4  justify-center">
  ...
  const mailingLists = [
    { id: 1, title: 'Employer', description: 'Company Owners and businesses', users: '621 users' },
    { id: 2, title: 'Employee', description: 'Individuals and freelancers', users: '1200 users' },
  ]
