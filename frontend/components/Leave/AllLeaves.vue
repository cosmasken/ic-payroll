...
const leaveType = [
  ...
  },
  {
    ...
    days: 90,
    description:
      "Maternity leave is a period of absence from work granted to a mother before and after the birth of her child. In the United States, many mothers are entitled to 12 weeks of unpaid maternity leave by law. The Family and Medical Leave Act of 1993 (FMLA) requires 12 weeks of unpaid leave annually for mothers of newborn or newly adopted children if they work for a company with 50 or more employees. Many states have separate laws that require paid maternity leave.",
    status: "Active",
  },
  {
    id: 4,
    ...
    days: 14,
    description:
      "Paternity leave is the time a father takes off work at the birth or adoption of a child. This kind of leave is rarely paid. A few progressive companies offer new dads paid time off ranging from a few days to a few weeks. The federal Family and Medical Leave Act (FMLA) provides eligible employees with up to 12 weeks of unpaid leave for the birth or adoption of a child.",
    status: "Active",
  },
];
