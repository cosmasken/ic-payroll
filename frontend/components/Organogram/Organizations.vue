...
const openOrganizationModal = ref(false);
...
watchEffect(async () => {
  try {
    ...
    authStore.updateOrganizations(organizations);
...
const toggleModal = () => {
  openOrganizationModal.value = !openOrganizationModal.value;
};
...
function close() {
  openOrganizationModal.value = false;
}
...
const addData = async () => {
  ...
  try {
    //  const res = await authStore.create_department(code,name);
    const response = await authStore.whoamiActor?.create_organization({
      code: code,
      name: name,
    });
                ...
                <div class="md:rounded-b-lg w-full">
                  <table class="divide-y divide-gray-300 w-full">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-[#fff]">
                      <tr
                        v-for="organization in organizationsArray"
                  ...
                  >
                    <div class="block">
                      <p class="text-sm text-gray-700">
                        ...
                        <span class="font-medium">{{ noOfOrganizations }}</span>
                        results
                      </p>
                    </div>
              ...
              <div class="p-4 sm:px-5 sm:py-5">
                <form>
                  ...
                  <div class="flex items-center justify-end gap-x-3">
                    <button
                      type="button"
                      @click="openOrganizationModal = false"
