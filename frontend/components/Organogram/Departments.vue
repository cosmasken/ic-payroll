...
const openDepartmentModal = ref(false);
...
const toggleModal = () => {
  openDepartmentModal.value = !openDepartmentModal.value;
};
...
const addData = async () => {
  ...
  try {
    const response = await authStore.whoamiActor?.create_department({
      code: code,
      name: name,
    });
  ...
  >
    <div class="mb-6">
      ...
      <p class="text-sm sm:text-base text-gray-500 font-normal">
        Your current departments and details
      </p>
    </div>
    <!-- title section -->
    <!-- table section -->
                  ...
                  >
                    <div class="block">
                      <p class="text-sm text-gray-700">
                        ...
                        <span class="font-medium">{{ noOfDepartments }}</span>
                        results
                      </p>
                    </div>
              ...
              <div class="p-4 sm:px-5 sm:py-5">
                <form>
                  ...
                  <div class="flex items-center justify-end gap-x-3">
                    <button
                      type="button"
                      @click="openDepartmentModal = false"
