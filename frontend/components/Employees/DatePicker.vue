...
<template>
  <div class="flex flex-col gap-2">
    <Label class="text-sm font-medium leading-6 text-gray-900 dark:text-white" for="date-field">Birthday</Label>
    <DatePickerRoot
      id="date-field"
    ...
    >
      ...
      >
        <div class="flex items-center">
          <template v-for="item in segments" :key="item.part">
            ...
            <DatePickerInput
              v-else
              :part="item.part"
              class="rounded-md p-0.5 focus:outline-none focus:shadow-[0_0_0_2px] focus:shadow-gray-500 aria-[valuetext=Empty]:text-green9 "
            >
              {{ item.value }}
            </DatePickerInput>
          </template>
        ...
        <DatePickerTrigger class="focus:shadow-[0_0_0_2px] rounded-md text-xl p-1 focus:shadow-gray-500">
