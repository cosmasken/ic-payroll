<template>
  <div class="container">
    <div class="flex flex-row justify-between pb-3 border border-gray-500 p-2 rounded-[10px]">
      <div class="px-4 py-1 dark:border-[#272730] text-end pl-0 flex flex-row justify-center align-middle">
        <span class="text-[12px] font-semibold leading-[22px] text-end text-[#219653]">{{sender}}</span>
        <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
      ...
      <div class="px-4 py-1 dark:border-[#272730]
       text-[#000] dark:text-white text-[12px] font-semibold leading-[28px] ">Deposit 
      </div>
       <div class="px-4 py-1 dark:border-[#272730] text-end ">
        <span class="text-[12px] font-semibold leading-[22px] text-end text-[#219653]">{{amount}}</span>
      </div>
      <div class="px-4 py-1 dark:border-[#272730] text-[#000]
       dark:text-white text-[12px] font-semibold leading-[22px] text-end ">{{created_at}}
      </div>
       <div class="px-4 py-1 dark:border-[#272730] text-end pr-0">
        <span class="px-2 py-0.5 rounded-[6px] w-[58px] inline-block text-center
       bg-[#63cf2433] text-[#349250] text-[10px] leading-[22px] font-semibold">Successful</span>
      </div>
    </div>
    <!--div class="flex flex-col divide-y rounded-md bg-gray-100 p-6">
      <div class="flex flex-row justify-between pb-3">
        <div class="flex flex-col">
          <div class="flex flex-row items-center">
            <span class="text-mbrs-titlecolor pr-1 text-base">{{
              sender
            }}</span>
            <svg
              width="16"
          ...
          <p class="truncate text-sm leading-6 text-black">
            Transaction Id : {{ id }}
          </p>
        </div>
        <div>
      ...
      <div class="pt-3 space-y-4">
        <div
          class="grid grid-cols-1 items-center gap-6 md:grid-cols-3 lg:grid-cols-6"
        >
...
<script setup>
const props = defineProps(["sender", "id", "receiver", "amount", "created_at"]);
