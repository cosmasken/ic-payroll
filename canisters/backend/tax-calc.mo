...
module {
    ...
    private func nhifDeduction(): Nat {
        if (salary >= 1000) {
            if (salary <= 5999) 150
            else if (salary <= 7999) 300
            else if (salary <= 11999) 400
            else if (salary <= 14999) 500
            else if (salary <= 19999) 600
            else if (salary <= 24999) 750
            else if (salary <= 29999) 850
            else if (salary <= 34999) 900
            else if (salary <= 39999) 950
            else if (salary <= 44999) 1000
            else if (salary <= 49999) 1100
            else if (salary <= 59999) 1200
            else if (salary <= 69999) 1300
            else if (salary <= 79999) 1400
            else if (salary <= 89999) 1500
            else if (salary <= 99999) 1600
            else 1700
        } else 0
    };
    ...
    private func getTaxOnTaxableIncome(): Nat {
        ...
        if (income <= 12298) income * 10 / 100
        else if (income <= 23885) income * 15 / 100
        else if (income <= 35472) income * 20 / 100
        else if (income <= 47059) income * 25 / 100
        else income * 30 / 100
    };
